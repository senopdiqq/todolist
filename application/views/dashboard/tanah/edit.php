        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">Edit Tanah</h1>
                </div>
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="nib" placeholder="10331955059" readonly autocomplete="off" class="form-control" name="nib" value="<?= $tanah->nib ?>">
                            </div>
                        </div>
                        <!-- End Form Group -->
                        <!-- Form Group -->
                            ...
                            <div class="col-sm-9">
                                <select id="pemohon" name="idPemohon" class="form-control" style="width: 100%">
                                    ...
                                    <?php foreach ($pemohon as $k) :  ?>
                                        <?php if ($tanah->idPemohon == $k->idPemohon) : ?>
                                            <option value="<?= $k->idPemohon ?>" <?= $data = (isset($_POST['idPemohon']) && $_POST['idPemohon'] == $k->idPemohon ? 'selected' : '') ?> selected><?= $k->nama . " / " .  $k->nik  ?></option>
                                        <?php else : ?>
                            ...
                            <div class="col-sm-9">
                                <select id="kecamatan" onchange="ajax()" name="idKecamatan" class="form-control" style="width: 100%">
                                    ...
                                    <?php foreach ($kecamatan as $k) :  ?>
                                        <?php if ($tanah->idKecamatan == $k->idKecamatan) : ?>
                                            <option value="<?= $k->idKecamatan ?>" <?= $data = (isset($_POST['idKecamatan']) && $_POST['idKecamatan'] == $k->idKecamatan ? 'selected' : '') ?> selected><?= $k->nama_kecamatan ?></option>
                                        <?php else : ?>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" autocomplete="off" class="form-control" name="luas_tanah" placeholder="3500.50" value="<?= $tanah->luas_tanah ?>">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="letak_tanah" placeholder="Malang" autocomplete="off" value="<?= $tanah->letak_tanah ?>">
                            </div>
                        </div>
                        <!-- End Form Group -->
                        <!-- Form Group -->
                        <div class="row form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="number" min="1" onkeydown="return event.keyCode !== 69" class="form-control" name="rt" placeholder="04" autocomplete="off" value="<?= $tanah->rt ?>">
                            </div>
                            <div class="col-sm-4">
                                <input type="number" maxlength="2" onkeydown="return event.keyCode !== 69" class="form-control" name="rw" placeholder="02" autocomplete="off" value="<?= $tanah->rw ?>">
                            </div>
                        </div>
                    ...
                    <div class="card-footer d-flex justify-content-end align-items-center">
                        <button type="submit" class="btn btn-primary">
                            <i class="tio-add-circle"></i> Edit Tanah
                        </button>
    ...
    function getSelectedDesa() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var option = ""
                obj.forEach(val => {
                    if (val.idDesa == <?= $tanah->idDesa ?>) {
                        option += `<option value = "${val.idDesa}" selected>${val.nama}</option>`
                    } else {
                        option += `<option value = "${val.idDesa}">${val.nama}</option>`
                    }
                })
                $("#desa").html(option);
            }
