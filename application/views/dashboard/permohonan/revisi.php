                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea readonly name="" id="" class="form-control" cols="30" rows="10"><?= $data->ket ?>
                                </textarea>
                                </div>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="nama_desa" class="col-sm-3 col-form-label input-label">Revisi Data Tanah</label>

                                <div class="col-sm-9">
                                    <a href="<?= base_url('Dashboard/Petugas/Tanah/edit/' . $data->nib) ?>" target="_blank" class="badge badge-danger p-2">Edit Data Tanah</a>
                                </div>
                            </div>
                            <!-- End Form Group -->
    ...
    <script>
        ...
        $('.revisiPemohon').click(function(e) {
            ...
            swal({
                    title: "Peringatan!",
                    text: "Dengan klik revisi, anda tidak dapat mengubahnya lagi!",
                    icon: "warning",
                    buttons: {
                        confirm: 'Ya, Revisi Pemohon',
                        cancel: 'Batal'
                    },
                    dangerMode: true,
                })
